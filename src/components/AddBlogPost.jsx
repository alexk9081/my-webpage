...
function AddBlogPost() {
    const [title, body, userName, userImg, setTitle, setBody] = useOutletContext();
    ...
    return (
        <div className={classes.blogPostSection}>
            ...
            <Link className={classes.changePage} to='/data/preview-blog'>Preview Post</Link>
        </div>
    )
}
